...
async def websocket_endpoint(
    ...
    try:
        ...
        # Prefer the canonical farmer_phone resolved earlier.
        # Never guess or default a phone number from user_id — if no verified
        # phone is linked to the session, skip cart restore.
